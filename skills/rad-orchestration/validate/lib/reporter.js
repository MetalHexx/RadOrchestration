...
function printHelp(orchRoot) {
  try {
    ...
    const helpText = [
      ...
      '',
      `Usage: node ${root}/skills/rad-orchestration/validate/validate-orchestration.js [options]`,
      '',
      'Options:',
      ...
      '',
      'Examples:',
      `  node ${root}/skills/rad-orchestration/validate/validate-orchestration.js                  Run all checks`,
      `  node ${root}/skills/rad-orchestration/validate/validate-orchestration.js --category agents  Check agents only`,
      `  node ${root}/skills/rad-orchestration/validate/validate-orchestration.js --verbose          Detailed output`,
      `  node ${root}/skills/rad-orchestration/validate/validate-orchestration.js --quiet            Summary only`,
      `  node ${root}/skills/rad-orchestration/validate/validate-orchestration.js --no-color         CI-friendly output`,
    ].join('\n') + '\n';
