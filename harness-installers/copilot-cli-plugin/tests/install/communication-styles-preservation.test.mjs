// harness-installers/copilot-cli-plugin/tests/install/communication-styles-preservation.test.mjs —
// Asserts the copilot-cli-plugin's manifest-driven install/upgrade preserves
