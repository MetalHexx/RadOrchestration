// harness-installers/copilot-cli-plugin/tests/install/action-events-preservation.test.mjs —
// FR-19, FR-20, FR-21, AD-10. Asserts the copilot-cli-plugin's manifest-driven
...
import { withTempHome, installFull, uninstallHarness, stagePluginRoot } from '../helpers/install-bench.js';
