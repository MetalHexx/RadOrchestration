// harness-installers/copilot-cli-plugin/tests/build/docs-corpus-bundling.test.mjs —
// Asserts the copilot-cli-plugin build stages the documentation corpus (README.md,
...
const INSTALLER_REL = 'harness-installers/copilot-cli-plugin';
