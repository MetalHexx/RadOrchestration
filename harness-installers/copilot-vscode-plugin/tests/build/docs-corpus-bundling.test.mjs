// harness-installers/copilot-vscode-plugin/tests/build/docs-corpus-bundling.test.mjs —
// Asserts the copilot-vscode-plugin build stages the documentation corpus (README.md,
...
const INSTALLER_REL = 'harness-installers/copilot-vscode-plugin';
