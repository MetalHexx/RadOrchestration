 ...
 *  plugin.json's version always wins. Published name is @rad-orchestration/copilot-vscode-plugin (FR-33). */
export function synthesizePackageJson({ wrapperPath, pluginJsonPath, outPath }) {
  ...
  const out = {
    name: '@rad-orchestration/copilot-vscode-plugin',
    version: pluginJson.version,
    description: wrapper.description ?? 'Copilot in VS Code marketplace plugin for rad-orchestration.',
