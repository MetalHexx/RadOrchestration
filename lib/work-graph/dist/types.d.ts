...
export type NodeStatus = 'not_started' | 'in_progress' | 'blocked' | 'done' | 'skipped' | 'unknown';
...
export interface WorkGraphError {
...
export declare const PROJECTION_SCHEMA: "work-graph/v1";
