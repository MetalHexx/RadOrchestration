...
**Prerequisite:** For baseline system context (agent roles, tier flow, event vocabulary, action routing), read the orchestration skill's [references/context.md](../../.claude/skills/orchestration/references/context.md).
