...
Edit each of these files — set `"version"` to the confirmed version number. All four must carry the same version:
...
```
git add installer/package.json ui/package.json skills/rad-orchestration/scripts/package.json cli/package.json
