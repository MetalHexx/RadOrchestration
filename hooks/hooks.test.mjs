...
test('hooks.json SessionStart invokes node skills/rad-orchestration/scripts/radorch.mjs plugin-bootstrap', () => {
  ...
  assert.match(hook.command, /skills[\/\\]rad-orchestration[\/\\]scripts[\/\\]radorch\.mjs/);
