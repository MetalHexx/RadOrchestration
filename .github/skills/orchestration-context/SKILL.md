...
description: 'Orchestration system context: agent roles, pipeline flow, naming conventions, key rules. Loaded by all pipeline agents to replace workspace-global instructions.'
---
...
System configuration lives in `{orch_root}/orchestration.yml`. It controls:
