          ...
          iterations: [
            {
              ...
              nodes: {
                ...
                phase_report: { kind: 'step', status: 'completed', doc_path: '/path/phase-report.md', retries: 0 },
                phase_review: { kind: 'step', status: 'completed', doc_path: '/path/phase-review.md', retries: 0 },
                phase_commit_gate: { kind: 'conditional', status: 'completed', branch_taken: 'true' },
                phase_commit: { kind: 'step', status: 'completed', doc_path: null, retries: 0 },
                task_loop: {
                  kind: 'for_each_task',
                  status: 'completed',
                  iterations: [
