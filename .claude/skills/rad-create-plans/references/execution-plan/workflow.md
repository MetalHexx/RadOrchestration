...
1. Read the Requirements doc. Build a mental inventory of every FR, NFR, AD,
   DD ID that must be addressed in the Execution Plan. Every ID should land in
...
9. Save to `{PROJECT-DIR}/{NAME}-EXECUTION-PLAN.md`.

## Output Contract

**Filename**: `{NAME}-EXECUTION-PLAN.md` at project root.
...
1. `# {PROJECT-NAME} — Execution Plan` (H1 title)
