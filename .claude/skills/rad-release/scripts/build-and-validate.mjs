...
export async function runBuildAndValidate({ repoRoot, spawn = spawnSync }) {
  // Step A: dogfood orchestrator builds all harnesses' agents/skills (AD-7)
  ...
  // invokes its validate.js Gate 3 (AD-6). Validator failure surfaces as
  // build non-zero exit, which halts the flow (FR-10).
