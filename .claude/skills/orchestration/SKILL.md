...
| Orchestrator | [references/action-event-reference.md](references/action-event-reference.md) | Complete Action Routing Table (23 actions) and Event Signaling Reference — quick lookup during pipeline operation |
