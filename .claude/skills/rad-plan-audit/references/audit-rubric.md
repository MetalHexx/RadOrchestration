...
| **Scope column coverage** | Every identifier in the Master Plan's phase scope (FR-N, NFR-N, AD-N, DD-N) appears in exactly one task row's Scope column in the corresponding Phase Plan — no identifiers lost, no identifiers duplicated across tasks |
