...
const groupB = ['execute-coding-task', 'log-error', 'orchestration', 'run-tests', 'source-control'];
for (const oldName of groupB) {
...
console.log('group-B rename assertions passed');
